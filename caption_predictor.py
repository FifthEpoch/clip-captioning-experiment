...
class CaptionPredictor:
        ...
        with torch.no_grad():
            ...
            for entry_idx in trange(entry_count):
                ...
                for i in range(entry_length):
                    ...
                    next_token_embed = self.model.gpt.transformer.wte(next_token)
                    if tokens is None:
                        tokens = next_token
                    else:
    ...
    def get_caption_prediction_from_embeddings(self, _emd, _is_gpu=True, _use_beam_search=True, _prefix_length=10):
        model_path = "pretrained/conceptual_weights.pt"

        is_gpu = _is_gpu
        use_beam_search = _use_beam_search
        ...
        model = ClipCaptionModel(_prefix_length)
        ...
        if use_beam_search:
            ...
            return self.generate2(model, tokenizer, embed=prefix_embed)

    def get_caption_prediction_from_image(self, _img_path, _is_gpu=True, _use_beam_search=True, _prefix_length=10):
        model_path = "pretrained/conceptual_weights.pt"
