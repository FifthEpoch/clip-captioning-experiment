...
# TODO: make this into a class structure
...
def get_caption_prediction_from_embeddings(_emd, _is_gpu=True, _use_beam_search=True, _prefix_length=10):
...
def get_caption_prediction_from_image(_img_path, _is_gpu=True, _use_beam_search=True, _prefix_length=10):
    model_path = "pretrained/conceptual_weights.pt"
